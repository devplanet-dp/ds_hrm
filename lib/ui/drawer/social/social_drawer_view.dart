...
class SocialDrawerView extends StatelessWidget {
  Function(int) selectedIndex;

  SocialDrawerView({Key? key, required this.selectedIndex}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<SocialDrawerViewModel>.reactive(
      onModelReady: (model) {
      ...
      viewModelBuilder: () => SocialDrawerViewModel(),
    );
  }
